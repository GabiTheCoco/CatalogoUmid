    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__3214EC075079138D", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Producto__3214EC07053C4CCD", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaveUsuario = table.Column<string>(type: "varchar(75)", unicode: false, maxLength: 75, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Usuario__5B65BF971DDCD808", x => x.IdUsuario);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Imagenes__3214EC07DD91B705", x => x.Id);
                    table.ForeignKey(
                        name: "FK__ImagenesP__IdPro__403A8C7D",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImagenesProductos_IdProducto",
